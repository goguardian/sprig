...
/** SprigPlugin */
/*
class SprigPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "sprig")
...
class SprigPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {

  companion object {
    const val TAG = "SprigPlugin"
  }
