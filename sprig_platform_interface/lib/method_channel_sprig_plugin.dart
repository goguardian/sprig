...
import 'sprig_platform_interface.dart';

/// An implementation of [SprigPlatform] that uses method channels.
class MethodChannelSprigPlugin extends SprigPlatform {
  final MethodChannel _channel = MethodChannel(Channels.CHANNEL);
